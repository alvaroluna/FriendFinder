...
*Friend Finder* application is meant to simulate a simple dating app - albeit one that matches you with a shiba inu that matches your temperament. The application is implemented using a [Node.js](https://nodejs.org/en/) and [Express](https://expressjs.com/) server on the back end and the [Materialize](http://materializecss.com/) CSS framework on the front end.
